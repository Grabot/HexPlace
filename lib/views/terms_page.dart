              ...
              child: Container(
                ...
                child: const Column(
                  ...
                  children: [
                    SizedBox(height: 10),
                    Text(
                        "End-User License Agreement (EULA) of Hex Place",
                    ...
                    SizedBox(height: 10),
                    Text(
                        "This EULA agreement governs your acquisition and use of our Hex Place software (\"Software\") directly from Zwaar developers or indirectly through a Zwaar developers authorized reseller or distributor (a \"Reseller\").",
                        style: TextStyle(color: Color(0xfff1f1f1), fontSize: 16)
                    ),
                    SizedBox(height: 10),
                    Text(
                        "Please read this EULA agreement carefully before completing the installation process and using the Hex Place software. It provides a license to use the Hex Place software and contains warranty information and liability disclaimers.",
                        style: TextStyle(color: Color(0xfff1f1f1), fontSize: 16)
                    ),
                    SizedBox(height: 10),
                    Text(
                        "If you register for a free trial of the Hex Place software, this EULA agreement will also govern that trial. By clicking \"accept\" or installing and/or using the Hex Place software, you are confirming your acceptance of the Software and agreeing to become bound by the terms of this EULA agreement.",
                        style: TextStyle(color: Color(0xfff1f1f1), fontSize: 16)
                    ),
                    SizedBox(height: 10),
                    Text(
                    ...
                    SizedBox(height: 10),
                    Text(
                        "Zwaar developers hereby grants you a personal, non-transferable, non-exclusive licence to use the Hex Place software on your devices in accordance with the terms of this EULA agreement.",
                        style: TextStyle(color: Color(0xfff1f1f1), fontSize: 16)
                    ),
                    SizedBox(height: 10),
                    Text(
                        "You are permitted to load the Hex Place software (for example a PC, laptop, mobile or tablet) under your control. You are responsible for ensuring your device meets the minimum requirements of the Hex Place software.",
                        style: TextStyle(color: Color(0xfff1f1f1), fontSize: 16)
                    ),
                    SizedBox(height: 10),
                    Text(
